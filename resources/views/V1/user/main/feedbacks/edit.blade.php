<?php $title = 'Редактирование отзыва' ?>
...
@section('content')
    <main>
        <section class="admin__users__table user-profile__container">
            <div class="container">
                <h1>Редактирование отзыва о "<span>{{$book->name}}"</span></h1>
                <form action="{{route('user.feedbacks.update', $feedback)}}" method="post">
                    @method('patch')
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="message" class="form-control" id="exampleFormControlTextarea1" rows="3">{{$feedback->message}}</textarea>
                        @error('message')
