                            ...
                            <form method="post" action="{{route('profile-update')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-row_">
                                    <div class="form-group form-col">
                                        ...
                                        <input type="text" name="name" value="{{\Illuminate\Support\Facades\Auth::user()->name}}" class="form-control" id="inputEmail4" placeholder="Введите имя">
                                        @error('name')
                                    ...
                                    <div class="form-group form-col">
                                        ...
                                        <input type="text" name="surname" value="{{\Illuminate\Support\Facades\Auth::user()->surname}}" class="form-control" id="inputPassword4" placeholder="Введите фамилию">
                                        @error('surname')
                                        <div class="text-danger mt-2">
                                            {{$message}}
                                        </div>
                                ...
                                <div class="form-row_">
                                    <div class="form-group form-col">
                                        ...
                                        <input type="email" value="{{\Illuminate\Support\Facades\Auth::user()->email}}" name="email" class="form-control" id="inputAddress" placeholder="Введите эл. почту">
                                        @error('email')
                                        <div class="text-danger mt-2">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="form-group form-col">
                                        ...
                                        <input type="text" name="login" value="{{\Illuminate\Support\Facades\Auth::user()->login}}" class="form-control" id="inputAddress2" placeholder="Введите логин">
                                        @error('login')
                                        <div class="text-danger mt-2">
                                            {{$message}}
                                        </div>
